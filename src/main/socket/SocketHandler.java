...
public class SocketHandler {
	...
	public StringTokenizer requestReservationList(String cookie, String state, String reservationDateFrom,
			String reservationDateTo, String searchType, String keywords) {
	...
	public StringTokenizer requestPatientInfo(String cookie, String patientId) {
		String requestData = "GET /hospitals/patients/info/" + patientId;
		requestData += "\n" + cookie;
	...
	public boolean processReservation(String cookie, String patientId, String reservationDate, String reservationTime,
			String docterName) {
